...
export const SHIP_DEFINITIONS: Record<string, { class: ShipClass; stats: ShipStats; displayName: string }> = {
  ...
  pyramid_ship: {
    class: 'dreadnought', // Commander flagship — requires idle commander to build
    displayName: 'Pyramid Flagship',
    stats: {
      maxHp: 280,
      maxShield: 150,
      shieldRegen: 4,
      ...
      abilities: [
        ...
        { id: 'fleet_warp', name: 'Fleet Warp', key: 'W', cooldown: 120, energyCost: 200, type: 'fleet_warp', duration: 2, warpSlots: 8, warpCountdown: 5 },
        { id: 'homebound', name: 'Emergency Recall', key: 'R', cooldown: 180, energyCost: 100, type: 'homebound', duration: 0 },
      ],
    },
  },
  ...
  custom_hero: {
    ...
    stats: {
      ...
      abilities: [
        ...
        { id: 'fleet_warp', name: 'Fleet Warp', key: 'W', cooldown: 90, energyCost: 250, type: 'fleet_warp', duration: 2, warpSlots: 12, warpCountdown: 5 },
        { id: 'homebound', name: 'Emergency Recall', key: 'R', cooldown: 120, energyCost: 150, type: 'homebound', duration: 0 },
      ],
    },
  },
};
