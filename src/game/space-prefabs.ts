...
export const FACTION_HERO_PREFABS: Record<string, SpacePrefab> = {
  ...
  // Pirate ships — unique enemy hull variants for campaign encounters
  pirate_01: {
    modelPath: `${NS}/Ship_enemy_01_Hull.fbx`,
    texturePath: `${NS}/Ship_enemy_01_Hull.png`,
    format: 'fbx',
    scale: 0.03,
    offset: S(0, 0, 0),
    enginePoints: [S(0, 0, -0.6)],
  ...
  pirate_02: {
    modelPath: `${NS}/Ship_enemy_02_Hull.fbx`,
    texturePath: `${NS}/Ship_enemy_02_Hull.png`,
    format: 'fbx',
    scale: 0.027,
    offset: S(0, 0, 0),
    enginePoints: [S(-0.4, 0, -0.8), S(0.4, 0, -0.8)],
  ...
  pirate_03: {
    modelPath: `${NS}/Ship_enemy_03_Hull.fbx`,
    texturePath: `${NS}/Ship_enemy_03_Hull.png`,
    format: 'fbx',
    scale: 0.024,
    offset: S(0, 0, 0),
    enginePoints: [S(-0.5, 0, -1.2), S(0.5, 0, -1.2)],
  ...
  pirate_04: {
    modelPath: `${NS}/Ship_enemy_07_Hull.fbx`,
    texturePath: `${NS}/Ship_enemy_07_Hull.png`,
    format: 'fbx',
    scale: 0.027,
    offset: S(0, 0, 0),
    enginePoints: [S(0, 0, -0.7)],
  ...
  pirate_05: {
    modelPath: `${NS}/Ship_enemy_09_Hull.fbx`,
    texturePath: `${NS}/Ship_enemy_09_Hull.png`,
    format: 'fbx',
    scale: 0.024,
    offset: S(0, 0, 0),
    enginePoints: [S(-0.5, 0, -1.0), S(0.5, 0, -1.0)],
    weaponPoints: [S(-0.3, 0.2, 0.8), S(0.3, 0.2, 0.8)],
  },
  pirate_06: {
    modelPath: `${NS}/Ship_enemy_11_Hull.fbx`,
    texturePath: `${NS}/Ship_enemy_11_Hull.png`,
    format: 'fbx',
    scale: 0.021,
    offset: S(0, 0, 0),
    enginePoints: [S(-0.6, 0, -1.4), S(0, 0, -1.4), S(0.6, 0, -1.4)],
  ...
  // Boss captains — elite encounter hulls
  boss_captain_01: {
    modelPath: `${NS}/Ship_enemy_12_Hull.fbx`,
    texturePath: `${NS}/Ship_enemy_12_Hull.png`,
    format: 'fbx',
    scale: 0.018,
    offset: S(0, 0, 0),
    enginePoints: [S(-0.8, 0, -1.8), S(0, 0, -1.8), S(0.8, 0, -1.8)],
...
export const EFFECT_PREFABS: Record<string, SpacePrefab> = {
  ...
  vfx_laser_beam: {
    modelPath: '/assets/space/models/effects-vfx/laser_beam_v2/scene.gltf',
    format: 'gltf',
    scale: 0.7,
    offset: S(0, 0, 0),
  },
  vfx_energy_trail: {
    modelPath: '/assets/space/models/effects-vfx/trail/scene.gltf',
    format: 'gltf',
    scale: 0.8,
    offset: S(0, 0, 0),
  },
  vfx_projectile_orb: {
    modelPath: '/assets/space/models/effects-vfx/uttvm_projectile/scene.gltf',
    format: 'gltf',
    scale: 0.75,
    offset: S(0, 0, 0),
  },
  vfx_hex_force_field: {
    modelPath: '/assets/space/models/effects-vfx/spherical_hex_force_field/scene.gltf',
    format: 'gltf',
    scale: 1.0,
    offset: S(0, 0, 0),
  },
  vfx_smoke_cloud: {
    modelPath: '/assets/space/models/effects-vfx/smoke/scene.gltf',
    format: 'gltf',
    scale: 0.9,
    offset: S(0, 0, 0),
  },
  vfx_particle_core: {
    modelPath: '/assets/space/models/effects-vfx/particle/scene.gltf',
    format: 'gltf',
    scale: 0.85,
    offset: S(0, 0, 0),
  },
