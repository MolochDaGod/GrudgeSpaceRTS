/**
 * codex-ui.tsx — Full-screen 3D Ship Codex with React overlay.
 *
 * Layout:
 ...
 * Right panel: ship detail (stats, abilities, lore, costs) — visible when a ship is selected.
          ...
          <div style={{ width: 320, padding: '20px 16px', overflowY: 'auto', height: '100%' }}>
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <div style={{ display: 'flex', gap: 6, marginTop: 6, flexWrap: 'wrap' }}>
                ...
                >
                  {selectedShip.isHero ? '★ HERO' : `TIER ${selectedShip.tier}`}
                </span>
                {selectedShip.role && (
                  <span
                    style={{
            ...
            >
              ...
              <StatBar label="HULL" value={selectedShip.stats.maxHp} max={2400} color="#44ee44" icon="♥" />
              <StatBar label="SHIELD" value={selectedShip.stats.maxShield} max={1000} color="#44ccff" icon="🛡" />
              <StatBar label="ARMOR" value={selectedShip.stats.armor} max={25} color="#8ac4d4" icon="⬡" />
              <StatBar label="DAMAGE" value={selectedShip.stats.attackDamage} max={200} color="#ff8844" icon="⚔" />
              <StatBar label="RANGE" value={selectedShip.stats.attackRange} max={500} color="#ffaa22" icon="◎" />
