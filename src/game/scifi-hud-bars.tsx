 ...
 *   FleetBar     — commander + 12 fleet ships with HP colors
 *   CommandCard  — 4 base commands + up to 4 active skills
 *   BuildQueueBar — planet icon, build queue, countdown timer
 */
...
// ═══════════════════════════════════════════════════════════════════════
// FLEET BAR — commander + 12 fleet ships
// ═══════════════════════════════════════════════════════════════════════
        ...
        return (
          ...
          >
            {ship && preview ? (
              ...
              <div style={{ fontSize: 8, color: '#4a7' }}>🚀</div>
            ) : null}
            {/* HP bar below slot */}
            {ship && (
              <div
...
// ═══════════════════════════════════════════════════════════════════════
// COMMAND CARD — 4 base commands + up to 4 skills + stop
// ═══════════════════════════════════════════════════════════════════════
      ...
      {Array.from({ length: 9 }, (_, i) => {
        ...
        return (
          ...
          >
            ...
            {baseCmd && (
              <>
                <div style={{ fontSize: 14, fontWeight: 800, color: '#44ffaa', lineHeight: 1 }}>
                  {baseCmd.id === 'attack' ? '⚔' : baseCmd.id === 'move' ? '➤' : baseCmd.id === 'patrol' ? '⟳' : '🛡'}
                </div>
            ...
            {isSkill && !ab && <div style={{ fontSize: 7, color: '#333' }}>—</div>}
            {/* Stop */}
            {isStop && (
              <>
                <div style={{ fontSize: 14, color: '#ff6644' }}>⏹</div>
...
// ═══════════════════════════════════════════════════════════════════════
// BUILD QUEUE BAR — planet icon, queue slots, countdown timer
// ═══════════════════════════════════════════════════════════════════════
    ...
    >
      ...
      >
        {planet ? (
          ...
          <div style={{ fontSize: 8, color: '#446' }}>—</div>
        )}
      </div>
